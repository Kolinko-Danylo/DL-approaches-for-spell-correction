...
def get_model(model_name, dataset_params, n_hidden, n_layers, drop_prob, grad_clip, attn_model, n_input):
  if model_name == "semichar_rnn":
    ...
    net = AttentionAutoencoder(n_input, n_hidden, n_layers, attn_model)
  else:
